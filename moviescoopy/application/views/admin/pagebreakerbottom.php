				  ...
				  <h5 style="margin-top:10px;margin-bottom:10px;">Max Image Dimension: 2000*1600</h5>
                      <section class="panel">
                          ...
                          <div class="panel-body">
							   <form action="<?php echo base_url();?>index.php/admin/pagebreaker/update_bottom" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">					
                                      <div class="form-group">
                                          <label class="control-label col-md-3">Title</label>
                                          <div class="col-md-4">
                                             <input class="form-control form-control-inline input-medium" value="<?php echo $pagebbottom[0]->title; ?>" name="sname" size="16" type="text" value="">
									   ...
									   <div class="form-group">
                                          ...
                                          <div class="col-md-4">
                                             <textarea class="form-control" name="description" cols="60" rows="5"><?php echo $pagebbottom[0]->desc; ?></textarea>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="controls col-md-9" id="img_more_app">
										    ...
										    <img src="<?php echo base_url();?>uploads/pagebreakers/<?php echo $pagebbottom[0]->img; ?>" style="height:80px;width:80px;padding-top:10px;padding-left:20px;">
