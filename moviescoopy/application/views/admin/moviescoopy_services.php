                      ...
                      <section class="panel profile-info">
					   <header class="panel-heading">
                          ...
                          <form action="<?php echo base_url();?>index.php/admin/moviescoopy/moviescoopy_save" method="post" enctype="multipart/form-data">
								...
								<textarea name="services" class="form-control form-control-inline input-medium" style="width:100%;height:500px;"><?php if(isset($content)){echo $content[0]->services;} ?></textarea>
