      ...
      <section id="main-content">
		  ...
		  <?php if($this->session->flashdata('serv_suc')){ ?>
             ...
             <span class="tools pull-right">
              ...
              <tbody>
			  <?php if(isset($celebs)){ foreach($celebs as $cele) { ?>
              <tr class="gradeX">
                  <td><?php echo $cele->name; ?></td>
                  <td><?php echo $cele->industry; ?></td>
				   <td><?php echo $cele->type; ?></td>
                  <td>
                     <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>index.php/admin/celebrity/editcelebrity?id=<?php echo $cele->cid; ?>"><i class="fa fa-pencil"></i></a>
                       <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>index.php/admin/celebrity/celebritypost?id=<?php echo $cele->cid; ?>"><i class="fa fa-post"></i></a>
                       
					   <a class="btn btn-danger btn-xs confirmClicksevt" href="<?php echo base_url();?>index.php/admin/events/delete_events?id=<?php echo $cele->cid; ?>"><i class="fa fa-trash-o "></i></a>
                  </td>
