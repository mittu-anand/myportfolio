 <!--main content start-->
		   ...
		   <?php if($this->session->flashdata('serv_suc')){ ?>
             ...
             <span class="tools pull-right">
              ...
              <tr class="gradeX">
                  ...
                  <td>
                     <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>index.php/admin/services/service?id=<?php echo $service->id; ?>"><i class="fa fa-pencil"></i></a>
                        <a class="btn btn-danger btn-xs confirmClicksrv"  href="<?php echo base_url();?>index.php/admin/services/delete_services?id=<?php echo $service->id; ?>"><i class="fa fa-trash-o "></i></a>
                  </td>
	...
	<script>
		$(".confirmClicksrv").click( function() {	
				if ($(this).attr('title')) {
