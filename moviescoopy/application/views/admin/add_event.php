                  ...
                  <div class="col-md-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
							   <form action="<?php echo base_url();?>index.php/admin/events/add_event" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">					
                                      <div class="form-group">
                                          <label class="control-label col-md-3">Add News</label>
                                          <div class="col-md-4">
                                             <input class="form-control form-control-inline input-medium" name="ename" size="16" type="text" value="">
									   ...
									   <div class="form-group">
                                          ...
                                          <div class="col-md-4">
                                             <textarea class="form-control" name="edescription" cols="60" rows="5"></textarea>
                                     ...
                                     <input type="submit" class="btn btn-success" name="event_submit" value="Update"/>
                              </form>
                          </div>
                      </section>
                  </div>
